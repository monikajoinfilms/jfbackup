// $Id: README.txt,v 1.1.4.1 2010/11/05 18:19:40 nicholasalipaz Exp $
...
### INSTALLING
  ...
  3. Navigate to Administration -> Configuration -> System -> Zopim and add your account number as well as any other configuration options you want.
